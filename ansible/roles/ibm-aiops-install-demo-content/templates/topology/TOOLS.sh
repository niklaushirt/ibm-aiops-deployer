    ...
    export TOPO_MGT_HOST=$(oc get route -n $AIOPS_NAMESPACE topology-manage -o jsonpath={.spec.host})
...
-H 'asm-proxy-Authorization: Basic YWlvcHMtdG9wb2xvZ3ktaWJtLWFpb3BzLXVzZXI6VnZRa2RzVEZzOUlNdmozMEg4VnFkc3dRemxlVmpKcmRIODg2bW93azBCaz0K' \
