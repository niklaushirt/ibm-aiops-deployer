...
# Create the Image
docker buildx build --platform linux/amd64 -t niklaushirt/ibm-aiops-pagerduty-incident-pusher:$CONT_VERSION --load .
docker push niklaushirt/ibm-aiops-pagerduty-incident-pusher:$CONT_VERSION
