...
podman login docker -u niklaushirt

export CONT_VERSION=1.0

cd eum-ng
podman buildx build --platform linux/amd64 -t docker.io/niklaushirt/eum-sim:$CONT_VERSION --load -f=Containerfile
podman push docker.io/niklaushirt/eum-sim:$CONT_VERSION
cd -


cd eum-mobile-app
podman buildx build --platform linux/amd64 -t quay.io/niklaushirt/eum-sim-mobile:$CONT_VERSION --load -f=Containerfile
podman push quay.io/niklaushirt/eum-sim-mobile:$CONT_VERSION
cd -
