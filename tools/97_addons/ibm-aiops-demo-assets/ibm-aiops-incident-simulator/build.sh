...
# Create the Image
docker buildx build --platform linux/amd64 -t quay.io/niklaushirt/ibm-aiops-incident-simulator:$CONT_VERSION --load .
docker push quay.io/niklaushirt/ibm-aiops-incident-simulator:$CONT_VERSION
