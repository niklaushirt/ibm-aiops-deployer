...
rm -r ../cloud-pak-deployer/automation-roles/50-install-cloud-pak/ibmaiops/
cp -r ./ansible/roles/ ../cloud-pak-deployer/automation-roles/50-install-cloud-pak/ibmaiops/

cd ../cloud-pak-deployer/automation-roles/50-install-cloud-pak/ibmaiops/
