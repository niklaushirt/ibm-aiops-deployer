...
export KAFKA_TOPIC_EVENTS=$(oc get kafkatopics -n $AIOPS_NAMESPACE | grep -v ibmaiopsibmaiops| grep -v noi-integration| grep -v "1000-1000"| grep ibmaiops-cartridge-alerts-$EVENTS_TYPE| awk '{print $1;}')
