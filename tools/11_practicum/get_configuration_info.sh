...
echo "            📥 Vault:"
echo "    " 
echo "                🌏 URL:           https://$(oc get route -n $AIOPS_NAMESPACE ibm-vault-deploy-vault-route -o jsonpath={.spec.host})"
echo "                🔐 Token:         $(oc get secret -n $AIOPS_NAMESPACE ibm-vault-deploy-vault-credential -o jsonpath='{.data.token}' | base64 --decode && echo)"
echo "    "
echo "    "
echo "    "
echo "    "
