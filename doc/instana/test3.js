...
(async function() {
  var getOptions = {
    url: 'https://robotshop-robot-shop.apps.ocp-270003bu3k-cunn.cloud.techzone.ibm.com',
  ...
  var getResponse = await $got.get(getOptions);
  ...
  var bodyObj1 = getResponse.body;


  var getOptions = {
    url: 'https://robotshop-robot-shop.apps.ocp-270003bu3k-cunn.cloud.techzone.ibm.com/product/EMM',
    https:{ rejectUnauthorized: false }, // accept self signed certificate
    headers: {
      'Additional-Header': 'Additional-Header-Data'
    }
